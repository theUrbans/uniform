...
let UTextarea = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uTextareaCss; }
};
UTextarea = /*@__PURE__*/ proxyCustomElement(UTextarea, [1, "u-textarea", {
    "disabled": [4],
    "readonly": [4],
    "label": [1],
    "required": [4],
...
function defineCustomElement() {
  ...
  const components = ["u-textarea"];
  components.forEach(tagName => { switch (tagName) {
    case "u-textarea":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UTextarea);
      }
      break;
  } });
}

export { UTextarea as U, defineCustomElement as d };
