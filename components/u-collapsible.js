...
let UCollapsible$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return uCollapsibleCss; }
};
UCollapsible$1 = /*@__PURE__*/ proxyCustomElement(UCollapsible$1, [1, "u-collapsible", {
    "label": [1],
    "size": [1],
    "isOpen": [32],
    "closeCollapsible": [64],
...
function defineCustomElement$1() {
  ...
  const components = ["u-collapsible"];
  components.forEach(tagName => { switch (tagName) {
    case "u-collapsible":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UCollapsible$1);
      }
      break;
  } });
}

const UCollapsible = UCollapsible$1;
const defineCustomElement = defineCustomElement$1;

export { UCollapsible, defineCustomElement };
