...
let UMenu$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uMenuCss; }
};
UMenu$1 = /*@__PURE__*/ proxyCustomElement(UMenu$1, [1, "u-menu", {
    "axis": [1],
    "width": [1],
    "padding": [4],
    "items": [16]
...
function defineCustomElement$1() {
  ...
  const components = ["u-menu"];
  components.forEach(tagName => { switch (tagName) {
    case "u-menu":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UMenu$1);
      }
      break;
  } });
}
...
export { UMenu, defineCustomElement };
