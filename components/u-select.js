...
let USelect$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uSelectCss; }
};
USelect$1 = /*@__PURE__*/ proxyCustomElement(USelect$1, [1, "u-select", {
    "options": [16],
    "searchable": [4],
    "multiple": [4],
    "value": [1032],
...
function defineCustomElement$1() {
  ...
  const components = ["u-select", "u-checkbox"];
  components.forEach(tagName => { switch (tagName) {
    case "u-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, USelect$1);
      }
      break;
    case "u-checkbox":
      if (!customElements.get(tagName)) {
...
const USelect = USelect$1;
const defineCustomElement = defineCustomElement$1;

export { USelect, defineCustomElement };
