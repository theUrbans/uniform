...
let UInput$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uInputCss; }
};
UInput$1 = /*@__PURE__*/ proxyCustomElement(UInput$1, [1, "u-input", {
    "value": [1032],
    "label": [1],
    "size": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["u-input"];
  components.forEach(tagName => { switch (tagName) {
    case "u-input":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UInput$1);
      }
      break;
  } });
}

const UInput = UInput$1;
const defineCustomElement = defineCustomElement$1;

export { UInput, defineCustomElement };
