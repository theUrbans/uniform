...
let UButton = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uButtonCss; }
};
UButton = /*@__PURE__*/ proxyCustomElement(UButton, [1, "u-button", {
    "design": [1],
    "outline": [4],
    "size": [1],
    "disabled": [4],
...
function defineCustomElement() {
  ...
  const components = ["u-button"];
  components.forEach(tagName => { switch (tagName) {
    case "u-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UButton);
      }
      break;
  } });
}

export { UButton as U, defineCustomElement as d };
