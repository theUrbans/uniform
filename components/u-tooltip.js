...
let UTooltip$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return uTooltipCss; }
};
UTooltip$1 = /*@__PURE__*/ proxyCustomElement(UTooltip$1, [1, "u-tooltip", {
    "text": [1],
    "axis": [1],
    "alignment": [1],
    "trigger": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["u-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "u-tooltip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UTooltip$1);
      }
      break;
  } });
}

const UTooltip = UTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { UTooltip, defineCustomElement };
