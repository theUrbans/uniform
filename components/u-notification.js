...
let UNotification$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h(Host, null, h("div", { class: {
        ...
        notification: true,
        [this.type]: true
      } }, h("div", { class: "close", onClick: () => this.handleClose(notification) }, "\u00D7"), h("h1", null, notification.title), notification.message && h("p", null, notification.message)))))));
  }
  static get watchers() { return {
    "newNotification": ["notificationsChanged"]
  }; }
  static get style() { return uNotificationCss; }
};
UNotification$1 = /*@__PURE__*/ proxyCustomElement(UNotification$1, [1, "u-notification", {
    "position": [1],
    "type": [32],
    "notifications": [32],
    "intervalls": [32],
    ...
    "error": [64],
    "warning": [64]
  }, [[16, "show-toast", "showToast"], [16, "clear-toast", "clearToast"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["u-notification"];
  components.forEach(tagName => { switch (tagName) {
    case "u-notification":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UNotification$1);
      }
      break;
  } });
}

const UNotification = UNotification$1;
const defineCustomElement = defineCustomElement$1;

export { UNotification, defineCustomElement };
