...
let UTouch$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return uTouchCss; }
};
UTouch$1 = /*@__PURE__*/ proxyCustomElement(UTouch$1, [1, "u-touch", {
    "swipeDir": [32],
    "distance": [32],
    "start": [32],
    "startTime": [32]
  }, [[17, "touchstart", "touchstart"], [17, "mousedown", "mousedown"], [17, "touchend", "touchend"], [17, "mouseup", "mouseup"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["u-touch"];
  components.forEach(tagName => { switch (tagName) {
    case "u-touch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UTouch$1);
      }
      break;
  } });
}

const UTouch = UTouch$1;
const defineCustomElement = defineCustomElement$1;

export { UTouch, defineCustomElement };
