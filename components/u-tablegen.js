...
import { d as defineCustomElement$2 } from './u-checkbox2.js';
...
let UTablegen$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.uSelect = createEvent(this, "uSelect", 7);
    this.uUnselect = createEvent(this, "uUnselect", 7);
    this.uStartHover = createEvent(this, "uStartHover", 7);
    this.uStopHover = createEvent(this, "uStopHover", 7);
    this.uLastElement = createEvent(this, "uLastElement", 7);
    /**
  ...
  render() {
    ...
    if (this.selectable)
      order = ['select', ...order];
    return (h(Host, null, h("table", null, h("thead", { class: {
        sticky: this.fixedHeader,
        top: true
      } }, h("tr", { class: "headingslot" }, h("td", { colSpan: order.length }, h("slot", { name: "header" }))), h("tr", { class: "heading" }, this.heading.map((item, index) => {
      var _a, _b;
      return [
        this.selectable && index === 0 && (h("th", { class: "center selectcell" }, h("u-checkbox", { checked: this.selected.length > 0, tristate: this.selected.length > 0 &&
        ...
        h("th", { class: {
          ...
          } }, h("span", { class: "label" }, item.label, item.sortable && (h("div", { class: "sort" }, (this.sort.prop !== item.field ||
          this.sort.dir === 'none') && [
      ...
      return this.observe && this.displayedData.length === rowIndex ? (h("u-observe", { onUVisble: () => this.uLastElement.emit() }, h("tr", { class: "tablerow", onClick: () => {
    ...
    })), h("tfoot", null, h("slot", { name: "footer" })))));
  }
  get el() { return this; }
  static get watchers() { return {
    "data": ["watchData"]
  }; }
  static get style() { return uTablegenCss; }
};
UTablegen$1 = /*@__PURE__*/ proxyCustomElement(UTablegen$1, [1, "u-tablegen", {
    "resizeable": [4],
    "selectable": [4],
    "fixedHeader": [4, "fixed-header"],
    "observe": [4],
    "heading": [16],
    "data": [1040],
    "sort": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["u-tablegen", "u-checkbox"];
  components.forEach(tagName => { switch (tagName) {
    case "u-tablegen":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UTablegen$1);
      }
      break;
    case "u-checkbox":
      if (!customElements.get(tagName)) {
...
const UTablegen = UTablegen$1;
const defineCustomElement = defineCustomElement$1;

export { UTablegen, defineCustomElement };
