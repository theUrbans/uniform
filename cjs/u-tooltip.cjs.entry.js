...
let UTooltip = class {
  ...
  render() {
    return (index.h("div", { class: "wrapper", onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, onMouseDown: this.handleClick }, index.h("div", { role: "tooltip", onMouseDown: (e) => e.stopPropagation(), class: {
        tooltip: true,
        visible: this.visible,
        invisible: !this.visible,
        [this.position]: true,
        [this.alignment]: true
      } }, !this.content ? this.text : index.h("slot", { name: "content" })), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
UTooltip.style = uTooltipCss;

exports.u_tooltip = UTooltip;
