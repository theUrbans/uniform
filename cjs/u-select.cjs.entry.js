...
let USelect = class {
  constructor(hostRef) {
    ...
    this.uInput = index.createEvent(this, "uInput", 7);
    this.uChange = index.createEvent(this, "uChange", 3);
    this.uFocus = index.createEvent(this, "uFocus", 7);
    this.uBlur = index.createEvent(this, "uBlur", 7);
    this.hovered = false;
    this.focus = false;
    this.options = [
  ...
  render() {
    ...
    return (index.h(index.Host, { tabindex: "0", onBlur: () => (this.focus = false) }, index.h("div", { onMouseEnter: () => (this.hovered = true), onMouseLeave: () => (this.hovered = false), class: {
        wrapper: true,
      ...
      ? this.selected.map((option, index$1) => {
        if (index$1 < this.shortenBreakpoint) {
          return (index.h("span", { class: "selected-option" }, option, index.h("span", { class: "selected-rm", onClick: () => this.removeOption(option) }, "\u00D7")));
        }
        if (index$1 === this.selected.length - 1) {
          return (index.h("span", { class: "selected-option" }, "+", this.selected.slice(this.shortenBreakpoint, -1).length +
            1));
        }
        return null;
      })
      : this.selected.map((option) => (index.h("span", { class: "selected-option" }, option, index.h("span", { class: "selected-rm", onClick: () => this.removeOption(option) }, "\u00D7")))), index.h("input", { class: {
        input: true,
        [`text-${this.size}`]: true
      }, ref: (input) => (this.inputElement = input), min: this.min, max: this.max, type: this.inputType, value: value, onInput: this.onInput, onBlur: this.onBlur, onClick: this.onClick, onFocus: this.onFocus, onKeyDown: this.onKeyDown, pattern: this.pattern, required: this.required, readonly: this.readonly || !this.searchable, disabled: this.disabled, autoComplete: this.autoComplete, autoCapitalize: this.autoCapitalize, autoCorrect: this.autoCorrect, spellcheck: this.spellCheck, autoFocus: false, placeholder: " " }), !!this.label || this.selected.length ? (index.h("label", { class: {
        label: true,
        [this.design]: true,
        [`label-${this.size}`]: true
      } }, this.required ? `${this.label} *` : this.label)) : null, index.h("div", { onClick: this.resetValue, onTouchStart: this.resetValue, class: {
        reset: true
      } }, this.value || this.searchValue ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, height: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": this.size === 'small' ? 1 : this.size === 'medium' ? 1.5 : 2, "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { d: "M15 15L9 9m6 0l-6 6", class: this.focus || this.hovered
        ? 'text-red-500'
        : 'text-gray-500' }), index.h("circle", { cx: "12", cy: "12", r: "10", class: this.focus || this.hovered
        ? 'text-red-500'
        : 'text-gray-500' }))) : null, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: { chevron: true, turn180: this.focus }, fill: "none", viewBox: "0 0 24 24", width: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, height: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, stroke: "currentColor" }, index.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": this.size === 'small' ? 1 : this.size === 'medium' ? 1.5 : 2, d: "M19 9l-7 7-7-7" }))), this.focus ? (index.h("div", { class: {
        options: true,
        optionsTop: this.position === 'top',
        optionsBottom: this.position === 'bottom'
      }, id: "options" }, this.filteredOptions.map(({ value, label, disabled, selected }) => (index.h("span", { class: {
        option: true,
      ...
      }, onMouseEnter: () => (this.index = this.filteredOptions.findIndex((option) => option.label === label)) }, this.multiple ? (index.h("u-checkbox", {
      // onUChange={() => {
