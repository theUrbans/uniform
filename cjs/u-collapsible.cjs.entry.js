...
let UCollapsible = class {
  constructor(hostRef) {
    ...
    this.uOpen = index.createEvent(this, "uOpen", 7);
    this.uClose = index.createEvent(this, "uClose", 7);
    /**
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { id: "collapsible", class: {
        spoiler: true,
        opened: this.isOpen,
        closed: !this.isOpen,
        [this.size]: true
      }, onClick: this.handleOnClick }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: { chevron: true, turn180: this.isOpen }, fill: "none", viewBox: "0 0 24 24", width: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, height: this.size === 'small' ? 16 : this.size === 'medium' ? 20 : 24, stroke: "currentColor" }, index.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": this.size === 'small' ? 1 : this.size === 'medium' ? 1.5 : 2, d: "M19 9l-7 7-7-7" })), index.h("span", null, this.label)), index.h("div", { class: "content", style: { opacity: '0' } }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
UCollapsible.style = uCollapsibleCss;

exports.u_collapsible = UCollapsible;
