...
let UProgress = class {
  ...
  render() {
    this.calcProgress();
    return (index.h("div", null, index.h("div", { class: { frame: true, border: !this.borderless } }, index.h("div", { class: "progress", style: {
        width: `${this.progressResult}%`,
        height: this.height
      } }, this.showPercentage ? (index.h("div", null, " ", this.progressResult, " %")) : (index.h("div", null, index.h("slot", null)))))));
  }
