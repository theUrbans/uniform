...
let UModal = class {
  constructor(hostRef) {
    ...
    this.beforeOpen = index.createEvent(this, "beforeOpen", 7);
    /**
  ...
  render() {
    return (index.h("div", { class: {
        wrapper: true,
        visible: this.isOpen
      }, onPointerDown: (e) => this.handleBlur(e), onPointerMove: (e) => this.handleMove(e), onPointerUp: () => this.mouseUp(), onClick: (e) => e.preventDefault() }, this.topRightClose && (index.h("button", { class: "close backdrop__close", onClick: this.handleCloseClick }, "\u00D7")), index.h("div", { class: {
        modal: true,
      ...
      } }, index.h("div", { class: "header", onPointerDown: (e) => this.handleStartDrag(e) }, index.h("span", { class: "header__title" }, index.h("slot", { name: "header" })), index.h("button", { class: "close header__close", onClick: this.handleCloseClick }, "\u00D7")), index.h("div", { class: {
        content: true
      } }, index.h("div", { style: {
        'min-width': this.minWidth,
        'min-height': this.minHeight,
