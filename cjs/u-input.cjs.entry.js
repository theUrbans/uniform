...
let UInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, this.showSlot === 'left' && index.h("slot", null), this.showSlot === 'both' && index.h("slot", { name: "left" }), index.h("div", { onMouseEnter: () => (this.hovered = true), onMouseLeave: () => (this.hovered = false), onClick: () => this.inputElement.focus(), class: {
        wrapper: true,
      ...
      } }, index.h("input", { type: this.inputType, class: {
        input: true,
        [`text-${this.size}`]: true
        // [`padding-${this.size}`]: this.hovered || this.focus || !!this.value,
      }, ref: (input) => (this.inputElement = input), value: value, onInput: this.onInput, onBlur: this.onBlur, onClick: this.onClick, onFocus: this.onFocus, onKeyDown: this.onKeyDown, placeholder: this.label }), this.label ? (index.h("label", { class: {
        label: true,
        [this.design]: true,
        [`label-${this.size}`]: true
      } }, this.required ? `${this.label} *` : this.label)) : null, !this.readonly && !this.disabled && this.value && (index.h("div", { onClick: this.resetValue, onTouchStart: this.resetValue, class: {
        reset: true
      } }, (this.focus || this.hovered || this.value) && (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: this.size === 'small'
        ? 16
        : this.size === 'medium'
          ? 20
        ...
        : this.size === 'medium'
          ? 20
          : 24, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": this.size === 'small' ? 1 : this.size === 'medium' ? 1.5 : 2, "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("path", { d: "M15 15L9 9m6 0l-6 6", class: this.focus || this.hovered
        ? 'text-red-500'
        : 'text-gray-500' }), index.h("circle", { cx: "12", cy: "12", r: "10", class: this.focus || this.hovered
        ? 'text-red-500'
        : 'text-gray-500' }))))), !this.validate ? (index.h("span", { class: { 'help-text': true } }, this.errorMsg)) : null), this.showSlot === 'right' && index.h("slot", null), this.showSlot === 'both' && index.h("slot", { name: "right" })));
  }
