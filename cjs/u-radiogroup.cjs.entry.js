...
let URadiogroup = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
        wrapper: true,
        [this.alignment]: true
      } }, this.label ? (index.h("span", { class: { label: true } }, this.label)) : null, this.options.map((option) => (index.h("label", { htmlFor: option.label, class: "container", onMouseEnter: () => (this.hovered = option.label), onMouseLeave: () => (this.hovered = '') }, option.label, index.h("input", { type: "radio", id: option.label, value: option.value, checked: this.value === option.value, onInput: (e) => this.handleInput(e, option), class: {
        checkbox: true
      } }), index.h("span", { class: {
        checkmark: true,
...
URadiogroup.style = uRadiogroupCss;

exports.u_radiogroup = URadiogroup;
