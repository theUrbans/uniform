...
let UButton = class {
  constructor(hostRef) {
    ...
    this.uClick = index.createEvent(this, "uClick", 7);
    /**
     * color design
     */
    this.design = 'primary';
  ...
  render() {
    return (index.h(index.Host, null, index.h("button", { onClick: this.handleOnClick, disabled: this.disabled, type: this.type, class: {
        button: true,
        [this.size]: true,
        [this.design]: true,
      ...
      } }, index.h("slot", { name: "prefix" }), index.h("slot", null, "Button Text"), index.h("slot", { name: "suffix" }))));
  }
};
UButton.style = uButtonCss;

exports.u_button = UButton;
